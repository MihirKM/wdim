...
public class ModItems {
	...
	public static final RegistryObject<Item> STRANGE_WITHER_SPAWN_EGG = ITEMS.register("strange_wither_spawn_egg",
			() -> new ModSpawnEggItem(ModEntityTypes.STRANGE_WITHER, 0x000000, 0xFF00FF,
					new Item.Properties().maxStackSize(64).group(ModItemsGroup.WDIM_GROUP)));
