...
public class StrangeWitherModel <T extends StrangeWitherEntity> extends SegmentedModel<T> {
	...
	public StrangeWitherModel() {
		...
		this.upperBodyParts[0].setTextureOffset(0, 16).addBox(-9.5F, -18.1F, 1.5F, 20.0F, 1.0F, 1.0F, 0.0F, false);
		...
		this.upperBodyParts[1].setTextureOffset(0, 53).addBox(1.5F, 0.0F, 2.0F, 1.0F, 10.0F, 1.0F, 0.0F, false);
		this.upperBodyParts[1].setTextureOffset(24, 53).addBox(-3.5F, 2.5F, 1.75F, 11.0F, 1.0F, 1.0F, 0.0F, false);
		this.upperBodyParts[1].setTextureOffset(24, 53).addBox(-3.5F, 5.0F, 1.75F, 11.0F, 1.0F, 1.0F, 0.0F, false);
		this.upperBodyParts[1].setTextureOffset(24, 53).addBox(-3.5F, 7.5F, 1.75F, 11.0F, 1.0F, 1.0F, 0.0F, false);
		...
		this.heads[0].setTextureOffset(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
		...
		this.heads[1].setTextureOffset(32, 0).addBox(-6.0F, -2.5F, -2.4F, 6.0F, 6.0F, 6.0F, 0.0F, true);
		...
		this.heads[2].setTextureOffset(32, 0).addBox(0.0F, -2.5F, -2.5F, 6.0F, 6.0F, 6.0F, 0.0F, false);
